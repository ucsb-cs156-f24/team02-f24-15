...
describe("MenuItemReviewEditPage tests", () => {
  ...
  describe("tests where backend is working normally", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock
        ...
        .reply(200, {
          id: 17,
          itemId: 6,
          reviewerEmail: "review1@ucsb.edu",
          stars: 2,
      ...
      axiosMock.onPut("/api/menuitemreview").reply(200, {
        id: "17",
        itemId: "5",
        reviewerEmail: "review2@ucsb.edu",
        stars: "1",
        dateReviewed: "2022-04-02T00:00",
        comments: "terrible",
      });
    });
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(reviewerEmailField).toHaveValue("review1@ucsb.edu");
      expect(starsField).toHaveValue(2);
      expect(dateReviewedField).toHaveValue("2022-03-02T00:00");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(reviewerEmailField, {
        target: { value: "review2@ucsb.edu" },
      });
      fireEvent.change(starsField, { target: { value: "1" } });
      fireEvent.change(dateReviewedField, {
        target: { value: "2022-04-02T00:00" },
      });
      fireEvent.change(commentsField, { target: { value: "terrible" } });

      fireEvent.click(submitButton);

      await waitFor(() => expect(mockToast).toBeCalled());
      expect(mockToast).toBeCalledWith(
        "MenuItemReview Updated - id: 17 itemId: 5",
      );
