...
public class RecommendationRequestIT {
        ...
        public void an_admin_user_can_post_a_new_recommendationrequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                        post("/api/recommendationrequest/post?requesterEmail=student1@ucsb.edu&professorEmail=prof1@ucsb.edu&explanation=explain&dateRequested=2024-11-11T00:00&dateNeeded=2024-11-12T00:00&done=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
